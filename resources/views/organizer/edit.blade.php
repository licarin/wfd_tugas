...
<body>
    <div class="container mt-5">
        <h1 class="mb-4">Edit Organizer: {{ $organizer->name }}</h1>
    ...
    <div class="form-group">
        ...
        <input type="url" name="facebook_link" class="form-control" value="{{ $organizer->facebook_link }}">
    </div>

    <div class="form-group">
        <label for="x_link">X Link:</label>
        <input type="url" name="x_link" class="form-control" value="{{ $organizer->x_link }}">
    </div>

    <div class="form-group">
        <label for="website_link">Website Link:</label>
        <input type="url" name="website_link" class="form-control" value="{{ $organizer->website_link }}">
    </div>
    ...
    <a href="{{ route('organizer.store', $organizer->id) }}" class="btn btn-secondary">Cancel</a>
</form>
